param(
  ...
  [string]$Aff4CaseRoot = "Q:\SpotlightCase\TestMacOS_AFF4_V1_6_77",
  [string]$ReaderToolsRoot = "",
  [string]$Aff4ZipPath = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_77.zip",
...
Write-Host "Vestigant Spotlight V1.6.77 automated workflow"
...
if ($SelectedWorkflow -eq "AFF4Probe") {
  ...
  $summaryPath = "D:\Downloads\V1_6_77_AFF4_WRAPPER_RUN_SUMMARY.txt"
  @(
    "Vestigant Spotlight V1.6.77 automated AFF4 wrapper run summary",
  ...
  if ($runnerExit -ne 0) {
    $emergencyZip = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_77_FAILED_WRAPPER_RESCUE.zip"
    $emergencyWork = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_77_FAILED_WRAPPER_RESCUE_Work"
    try {
...
@"
Vestigant Spotlight V1.6.77 automated wrapper run summary
...
@"
Vestigant Spotlight V1.6.77 automated chat upload bundle
Created: $(Get-Date -Format o)
Build log: $BuildLog

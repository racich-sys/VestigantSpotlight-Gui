...
void usage() {
    std::cout << appTitle() << "\n\n"
              ...
              << "  Active filesystem comparison uses in-case iOS FFS exact-path lookup when available. --evidence-root is accepted for compatibility but direct evidence-root comparison remains pending in V1.6.29.4.\n"

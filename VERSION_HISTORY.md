...
- No parser/output behavior change intended beyond restoring GUI buildability.
...
## V0_9_11_1 - GUI compile fix / reuse-cache script speed default

- Fixes GUI-only MSVC C2026 oversized string-literal compile failure.
- Keeps CLI/self-test path from V0_9_7_1 intact.
- Reuse-cache helper script now skips full 250+ GB source ZIP hashing by default for development iteration.

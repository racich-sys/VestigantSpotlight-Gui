...
```text
Vestigant Spotlight v1.2.0
```

Build log output:

```text
D:\Downloads\V1_2_0_build.log
```

Thin output:

```text
D:\Downloads\Upload_Thin_MacOS_AFF4_V1_2_0.zip
```

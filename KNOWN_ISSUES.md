...
- Windows/MSVC build for V1.6.37.1 is not verified until `V1_6_38_build.log` is uploaded.
...
- Windows/MSVC build validation is pending until `V1_6_38_build.log` is uploaded.
...
- Windows/MSVC build validation is pending until the user uploads `V1_6_38_build.log`.
...
- V1.6.37.1 Windows/MSVC build is not verified until `V1_6_38_build.log` is uploaded and reviewed.
...
- GUI source changes are statically checked in this package but require Windows/MSVC build validation from `V1_6_38_build.log`.
...
- V1.6.37.1 Windows/MSVC build is not verified until `V1_6_38_build.log` is uploaded.

...
## V0_9_39 corrective action

V0_9_39 keeps Missing From FFS text visibility, but restores a bounded text-context budget suitable for normal investigator mode:
...
V0_9_39 also fixes fatal guardrail propagation so SQLite guardrail hits stop cleanly and do not continue into secondary COMMIT errors.

# V1.6.40.1.1 macOS Store-V2 Native Path Probe Promotion
...
V1.6.40.1.1 adds a SQLite-native enrichment pass immediately after artifact creation and before source-copy comparison, parent-inode linking, and timeline materialization.

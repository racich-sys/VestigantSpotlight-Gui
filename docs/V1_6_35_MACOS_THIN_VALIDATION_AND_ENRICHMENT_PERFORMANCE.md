# V1_6_35 macOS zipped Spotlight thin validation and enrichment performance
...
V1.6.35 skips the parent-inode path apply UPDATE when `newReconstructedPathRows == 0`. It writes explicit run-status markers:

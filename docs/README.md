...
# Vestigant Spotlight V1.6.41.1

V1.6.41.1 adds a CoreDuet `interactionC.db` investigator workflow and keeps a running start-continuation handoff in `docs/START_CONTINUATION_CHAT.md`.

...
Get-FileHash .\VestigantSpotlightInv_V0_9_47.zip -Algorithm SHA256
Remove-Item -LiteralPath "T:\VestigantSpotlightInv_V0_9_47" -Recurse -Force -ErrorAction SilentlyContinue
Expand-Archive -LiteralPath .\VestigantSpotlightInv_V0_9_47.zip -DestinationPath T:\ -Force
& "T:\VestigantSpotlightInv_V0_9_47\build_windows_msvc.bat" 2>&1 | Tee-Object -FilePath "D:\Downloads\V0_9_47_build.log"
& "T:\VestigantSpotlightInv_V0_9_47\build-msvc\Release\VestigantSpotlightCli.exe" --version
& "T:\VestigantSpotlightInv_V0_9_47\build-msvc\Release\VestigantSpotlightTests.exe" "T:\VestigantSpotlightInv_V0_9_47\build-msvc\selftest_out"
```
...
```powershell
powershell -ExecutionPolicy Bypass -File "T:\VestigantSpotlightInv_V0_9_47\scripts\Run-V0_9_47-iOS-ReuseCache-CLI-AndZip.ps1" `
  ...
  -OutZip "D:\Downloads\Upload_Thin_iOS_GUI_V0_9_47_ReusedCache_Check.zip"
```
...
If a run stalls or stops writing, use the matching `Collect-V0_9_47-DBBloat-State.ps1` script before stopping/rerunning:
...
- `D:\Downloads\V0_9_47_build.log`
- `D:\Downloads\Upload_Thin_iOS_GUI_V0_9_47_ReusedCache_Check.zip`

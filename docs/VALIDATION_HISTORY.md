...
- V0_9_30 validation focus: documentation consolidation, improved compact message/body extraction, parser diagnostics detail sample, schema smoke coverage, and MSVC raw-string risk checks.

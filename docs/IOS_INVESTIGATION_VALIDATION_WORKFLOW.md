# iOS Investigation Validation Workflow - V1.6.35

1. Build V1.6.35 and review `V1_6_35_build.log`.
2. Run `scripts\Run-V1_6_35-iOS-CoreSpotlight-AndZip.ps1 -CleanOut`.
3. Upload `Upload_Thin_iOS_CoreSpotlight_V1_6_35.zip`.

# iOS Investigation Validation Workflow - V1.6.40.1.1

1. Build V1.6.40.1.1 and review `V1_6_40_1_build.log`.
2. Run `scripts\Run-V1_6_40_1-iOS-CoreSpotlight-AndZip.ps1 -CleanOut`.
3. Upload `Upload_Thin_iOS_CoreSpotlight_V1_6_40_1.zip`.

# iOS Investigation Validation Workflow - V1.6.38

1. Build V1.6.38 and review `V1_6_38_build.log`.
2. Run `scripts\Run-V1_6_38-iOS-CoreSpotlight-AndZip.ps1 -CleanOut`.
3. Upload `Upload_Thin_iOS_CoreSpotlight_V1_6_38.zip`.

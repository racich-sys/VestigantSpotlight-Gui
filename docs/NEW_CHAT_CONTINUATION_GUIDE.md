# New Chat Continuation - Current V1.2.1

Upload at minimum:
- `VestigantSpotlightInv_V1_2_1.zip`
- `V1_2_1_build.log` after build
- `Upload_Thin_MacOS_AFF4_V1_2_1.zip` after thin run
- Any new notes/suggestions
...
- Newest source package: `VestigantSpotlightInv_V1_2_1.zip`
...
1. Current source ZIP: `VestigantSpotlightInv_V1_2_1.zip`.
2. Current Windows/MSVC build log after running: `V1_2_1_build.log`.
3. Current macOS AFF4/APFS thin output after running: `Upload_Thin_MacOS_AFF4_V1_2_1.zip`.
...
- Current source extraction: `T:\VestigantSpotlightInv_V1_2_1`

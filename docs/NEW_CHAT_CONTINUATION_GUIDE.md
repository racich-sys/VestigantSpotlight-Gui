# New Chat Continuation - Current V1.3.0

Upload at minimum:
- `VestigantSpotlightInv_V1_3_0.zip`
- `V1_3_0_build.log` after build
- `Upload_Thin_MacOS_AFF4_V1_3_0.zip` after thin run
...
- Newest source package: `VestigantSpotlightInv_V1_3_0.zip`
...
1. Current source ZIP: `VestigantSpotlightInv_V1_3_0.zip`.
2. Current Windows/MSVC build log after running: `V1_3_0_build.log`.
3. Current macOS AFF4/APFS thin output after running: `Upload_Thin_MacOS_AFF4_V1_3_0.zip`.
...
- Current source extraction: `T:\VestigantSpotlightInv_V1_3_0`

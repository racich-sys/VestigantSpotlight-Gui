# V1.6.41.1 CSV Default, Source-Profile Filtering, and Unresolved Label Path Guard

## Scope

V1.6.41.1 implements the queued post-V1.6.37.1 workflow changes and one thin-run-derived corrective fix:
...
Local Linux build and smoke test completed for V1.6.41.1. Windows/MSVC validation still requires the user-provided build log.

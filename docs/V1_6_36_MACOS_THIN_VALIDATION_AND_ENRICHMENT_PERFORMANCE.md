# V1_6_41 macOS zipped Spotlight thin validation and enrichment performance
...
V1.6.41.1 skips the parent-inode path apply UPDATE when `newReconstructedPathRows == 0`. It writes explicit run-status markers:

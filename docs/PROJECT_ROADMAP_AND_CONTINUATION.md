...
Current baseline: V0_9_34.

## Current status

V0_9_33 built successfully on Windows/MSVC and the iOS reuse-cache run reached `complete_success` with stable compact-mode counts.  V0_9_34 is a safe cleanup/consolidation release: it corrects stale package metadata, removes old documentation/script clutter from the production ZIP, and preserves the current iOS Spotlight parser/view behavior.

## Near-term priorities

1. Validate V0_9_34 on Windows/MSVC and run the standard iOS reuse-cache test.

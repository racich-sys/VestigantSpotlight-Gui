...
V1.3.7 also retains the V1.3.6.1 iOS thin safeguard: standard iOS thin mode should not materialize the full 2.2M-row FFS inventory unless full/support diagnostics are explicitly requested.

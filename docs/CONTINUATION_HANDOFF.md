...
- Current source package: `VestigantSpotlightInv_V1_1_1.zip`
- Version string: `1.1.1`
- Base version reviewed before this package: `V1.1.0.1`
...
V1.1.1 is a broader repeat-cycle release focused on evidence-intake isolation and GUI ingest-thread safety. It preserves extraction semantics while moving more iOS inventory import logic out of `app_runner.cpp`.
...
- Current source extraction: `T:\VestigantSpotlightInv_V1_1_1`
...
Get-FileHash .\VestigantSpotlightInv_V1_1_1.zip -Algorithm SHA256
Remove-Item -LiteralPath "T:\VestigantSpotlightInv_V1_1_1" -Recurse -Force -ErrorAction SilentlyContinue
Expand-Archive -LiteralPath .\VestigantSpotlightInv_V1_1_1.zip -DestinationPath T:\ -Force
powershell -ExecutionPolicy Bypass -File T:\VestigantSpotlightInv_V1_1_1\scripts\Build-V1_1_1.ps1
powershell -ExecutionPolicy Bypass -File T:\VestigantSpotlightInv_V1_1_1\scripts\Run-V1_1_1-macOS-AFF4-Probe-AndZip.ps1 -CleanOut
```

## Next recommended validation

1. Windows/MSVC build for V1.1.1.
2. macOS AFF4/APFS thin run for V1.1.1.
3. Current iOS run because V1.1.1 moved the iOS inventory import boundary into `EvidenceIntake`.

## Next recommended work after V1.1.1 validates

1. Compare V1.1.1 AFF4/APFS thin output to V1.1.0.1 baseline.
...
3. Move `stageZipEvidenceSource(...)` only after the V1.1.1 intake-import relocation validates.

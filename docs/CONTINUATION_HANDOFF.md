# Current Continuation Handoff - V1.2.1
...
Current change:
- APFS guided target inode/file-extent lookup buffer reuse in `src/parsers/aff4_probe_worker.cpp`.
- No intended forensic output semantic changes.

Next upload needed:
- `V1_2_1_build.log`
- `Upload_Thin_MacOS_AFF4_V1_2_1.zip`

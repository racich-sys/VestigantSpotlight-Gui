...
Use V1.4.2 after V1.3.6 iOS thin failed with `database or disk is full` during `ios_ffs_inventory_csv_stream_import`. The corrected standard iOS thin path uses slim FFS lookup unless explicit full/support materialization is requested.

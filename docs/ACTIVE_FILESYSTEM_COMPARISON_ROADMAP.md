# Active Filesystem Comparison Roadmap - V1.6.28

V1.6.27 produced 7,766 materialized Missing-from-FFS reference candidates and passed eight active-comparison validation checks. V1.6.28 targets the remaining lookup-source REVIEW by preserving lookup source through the GUI/review Missing-from-FFS view and candidate materialization.

# Active Filesystem Comparison Roadmap - V1.6.28

V1.6.26 produced a completed iOS FFS exact-path plus Spotlight reference lookup run with 7,766 materialized reference candidates. V1.6.28 adds validation checks to confirm:
...
V1.6.28 adds validation views and upload samples for the current iOS FFS active-comparison workflow.
...
- Validate V1.6.28 count consistency and lookup-source preservation.

...
Get-FileHash .\VestigantSpotlightInv_V0_9_44.zip -Algorithm SHA256
Remove-Item -LiteralPath "T:\VestigantSpotlightInv_V0_9_44" -Recurse -Force -ErrorAction SilentlyContinue
Expand-Archive -LiteralPath .\VestigantSpotlightInv_V0_9_44.zip -DestinationPath T:\ -Force
& "T:\VestigantSpotlightInv_V0_9_44\build_windows_msvc.bat" 2>&1 | Tee-Object -FilePath "D:\Downloads\V0_9_44_build.log"
& "T:\VestigantSpotlightInv_V0_9_44\build-msvc\Release\VestigantSpotlightCli.exe" --version
& "T:\VestigantSpotlightInv_V0_9_44\build-msvc\Release\VestigantSpotlightTests.exe" "T:\VestigantSpotlightInv_V0_9_44\build-msvc\selftest_out"
```

## iOS reuse-cache test

```powershell
powershell -ExecutionPolicy Bypass -File "T:\VestigantSpotlightInv_V0_9_44\scripts\Run-V0_9_44-iOS-ReuseCache-CLI-AndZip.ps1" `
  ...
  -CaseRoot "Q:\SpotlightCase\TestiOS_WhatsApp_V0_9_44_ReusedCache" `
  -OutZip "D:\Downloads\Upload_Thin_iOS_GUI_V0_9_44_ReusedCache_Check.zip"
```

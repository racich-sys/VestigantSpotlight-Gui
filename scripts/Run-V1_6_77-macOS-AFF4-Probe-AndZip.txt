param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\TestMacOS_AFF4_V1_6_77",
  [string]$ReaderToolsRoot = "",
  [string]$ExternalSpotlightRoot = "",
  [string]$ExternalCompareOutRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_77_ExternalCompare",
  [string]$UploadWorkRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_77_UploadWork",
...
if ($ForceContainerHash -or $FullNoGuardrails) { $runnerArgs += "-ForceContainerHash" }
if ($FullNoGuardrails) {
  $runnerArgs += "-FullScan"
...
if ($LASTEXITCODE -ne 0) { throw "AFF4/APFS V1.6.77 probe wrapper failed with exit code $LASTEXITCODE. Review case folder: $CaseRoot" }

param(
  [string]$ZipPath = "D:\Downloads\VestigantSpotlightInv_V1_0_13.zip",
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V1_0_13",
  [string]$BuildLog = "D:\Downloads\V1_0_13_build.log",
  [switch]$CleanExtract
)
...
if ($version -notmatch "1\.0\.13") { throw "Unexpected CLI version after build: $version" }
Write-Host $version

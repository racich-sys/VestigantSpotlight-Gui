...
$CaseRoot = "Q:\SpotlightCase\TestiOS_V0_9_53_CLI"
$InputZip = "T:\0202_0024-IT002\00008132-000269523699001C_files_full.zip"
$OutZip = "D:\Downloads\Upload_Thin_iOS_CLI_V0_9_53_Check.zip"
$Work = "D:\Downloads\Upload_Thin_iOS_CLI_V0_9_53_Check"

if (!(Test-Path -LiteralPath $Cli)) { throw "CLI not found. Run scripts\Build-V0_9_53.ps1 first: $Cli" }
...
& "$SourceRoot\scripts\Package-V0_9_53-iOS-ThinUpload.ps1" -CaseRoot $CaseRoot -OutZip $OutZip -Work $Work

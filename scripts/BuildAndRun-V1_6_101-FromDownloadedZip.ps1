param(
  ...
  [string]$ThinCaseRoot = "Q:\SpotlightCase\TestIOS_CoreSpotlight_V1_6_101",
  [string]$ThinZipPath = "D:\Downloads\Upload_Thin_iOS_CoreSpotlight_V1_6_101.zip",
  [string]$ChatUploadBundlePath = "D:\Downloads\Upload_To_Chat_V1_6_101_Results.zip",
  [string]$ChatUploadBundleWorkRoot = "D:\Downloads\Upload_To_Chat_V1_6_101_Results_Work",
  ...
  [string]$Aff4CaseRoot = "Q:\SpotlightCase\TestMacOS_AFF4_V1_6_101",
  [string]$ReaderToolsRoot = "",
  [string]$Aff4ZipPath = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_101.zip",
...
$SourceRoot = Join-Path $DestinationRoot "VestigantSpotlightInv_V1_6_101"
if ($UseFastLocalCaseRoot -and $SelectedWorkflow -eq "IOSCoreSpotlightThin") {
  $ThinCaseRoot = Join-Path $FastLocalRoot "TestIOS_CoreSpotlight_V1_6_101"
  Write-Host "Using fast local thin case root: $ThinCaseRoot"
}

Write-Host "Vestigant Spotlight V1.6.101 automated workflow"
...
$BuildScript = Join-Path $SourceRoot "scripts\Build-V1_6_101.ps1"
...
if ($SelectedWorkflow -eq "AFF4Probe") {
  ...
  $summaryPath = "D:\Downloads\V1_6_101_AFF4_WRAPPER_RUN_SUMMARY.txt"
  @(
    "Vestigant Spotlight V1.6.101 automated AFF4 wrapper run summary",
  ...
  if ($runnerExit -ne 0) {
    $emergencyZip = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_101_FAILED_WRAPPER_RESCUE.zip"
    $emergencyWork = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_101_FAILED_WRAPPER_RESCUE_Work"
    try {
...
$ThinScript = Join-Path $SourceRoot "scripts\Run-V1_6_101-iOS-CoreSpotlight-AndZip.ps1"
...
Copy-IfExistsToBundle -Path $BuildLog -Name "V1_6_101_build.log"
Copy-IfExistsToBundle -Path $ThinZipPath -Name "Upload_Thin_iOS_CoreSpotlight_V1_6_101.zip"
...
@"
Vestigant Spotlight V1.6.101 automated wrapper run summary
...
@"
Vestigant Spotlight V1.6.101 automated chat upload bundle
Created: $(Get-Date -Format o)
Build log: $BuildLog

param(
  [string]$ZipPath = "D:\Downloads\VestigantSpotlightInv_V0_9_60.zip",
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V0_9_60",
  [string]$BuildLog = "D:\Downloads\V0_9_60_build.log",
  [switch]$CleanExtract
)
...
# V0_9_60 is a V1 production-readiness cleanup. Force removal of stale GUI/link

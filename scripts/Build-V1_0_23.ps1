param(
  [string]$ZipPath = "D:\Downloads\VestigantSpotlightInv_V1_0_23.zip",
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V1_0_23",
  [string]$BuildLog = "D:\Downloads\V1_0_23_build.log",
  [switch]$CleanExtract
)
...
if ($version -notmatch "1\.0\.23") { throw "Unexpected CLI version after build: $version" }
Write-Host $version

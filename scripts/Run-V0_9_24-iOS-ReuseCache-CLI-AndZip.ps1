param(
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V0_9_24",
  ...
  [string]$OutZip = "D:\Downloads\Upload_Thin_iOS_GUI_V0_9_24_ReusedCache_Check.zip"
)
...
powershell -ExecutionPolicy Bypass -File "$SourceRoot\scripts\Package-V0_9_24-iOS-ThinUpload.ps1" -CaseRoot $CaseRoot -OutZip $OutZip

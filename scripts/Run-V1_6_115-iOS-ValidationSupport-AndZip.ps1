param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\ValidationSupportIOS_CoreSpotlight_V1_6_115",
  [string]$ZipPath = "D:\Downloads\Upload_ValidationSupport_iOS_CoreSpotlight_V1_6_115.zip",
  [switch]$CleanOut,
...
if ($LASTEXITCODE -ne 0) {
  ...
  throw "iOS CoreSpotlight V1.6.115 validation support wrapper failed with exit code $LASTEXITCODE"
}

param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\BoundedFullNativeIOS_CoreSpotlight_V1_6_77",
  [string]$ZipPath = "D:\Downloads\Upload_BoundedFullNative_iOS_CoreSpotlight_V1_6_77.zip",
...
if ($LASTEXITCODE -ne 0) {
  ...
  throw "iOS CoreSpotlight V1.6.77 bounded full-native DB wrapper failed with exit code $LASTEXITCODE"
}

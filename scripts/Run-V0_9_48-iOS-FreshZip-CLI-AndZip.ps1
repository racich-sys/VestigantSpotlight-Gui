param(
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V0_9_48",
  [string]$InputZip = "F:\0446_0001-IT006\00008130-001A75AA1A21001C-2025-12-03-T224939\00008130-001A75AA1A21001C_files_full.zip",
  [string]$CaseRoot = "Q:\SpotlightCase\TestiOS_WhatsApp_V0_9_48_FreshZip",
  [string]$OutZip = "D:\Downloads\Upload_Thin_iOS_GUI_V0_9_48_FreshZip_Check.zip"
)
...
powershell -ExecutionPolicy Bypass -File "$SourceRoot\scripts\Package-V0_9_48-iOS-ThinUpload.ps1" -CaseRoot $CaseRoot -OutZip $OutZip

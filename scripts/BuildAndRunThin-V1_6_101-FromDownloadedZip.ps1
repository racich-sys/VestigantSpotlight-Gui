...
if ($PressureTestMode -or $FullDiagnostics) { $thinArgList += "-PressureTestMode" }
...
@"
Vestigant Spotlight V1.6.101 wrapper run summary
...
@"
Vestigant Spotlight V1.6.101 chat upload bundle
Created: $(Get-Date -Format o)
Build log: $BuildLog

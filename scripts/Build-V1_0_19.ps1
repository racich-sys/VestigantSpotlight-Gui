param(
  [string]$ZipPath = "D:\Downloads\VestigantSpotlightInv_V1_0_19.zip",
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V1_0_19",
  [string]$BuildLog = "D:\Downloads\V1_0_19_build.log",
  [switch]$CleanExtract
)
...
if ($version -notmatch "1\.0\.19") { throw "Unexpected CLI version after build: $version" }
Write-Host $version

param(
  ...
  [string]$OutZip = "D:\Downloads\Upload_Thin_iOS_GUI_V0_9_57_ReusedCache_Check.zip"
)
...
powershell -ExecutionPolicy Bypass -File "$SourceRoot\scripts\Package-V0_9_57-iOS-ThinUpload.ps1" -CaseRoot $CaseRoot -OutZip $OutZip

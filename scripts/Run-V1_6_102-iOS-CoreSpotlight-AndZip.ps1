param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\TestIOS_CoreSpotlight_V1_6_102",
  [string]$ZipPath = "D:\Downloads\Upload_Thin_iOS_CoreSpotlight_V1_6_102.zip",
  [switch]$CleanOut,
...
if ($PressureTestMode -or $FullDiagnostics) { $args.PressureTestMode = $true }
...
if ($LASTEXITCODE -ne 0) {
  if (Test-Path -LiteralPath $ZipPath) {
    ...
    throw "iOS CoreSpotlight V1.6.102 thin wrapper failed with exit code $LASTEXITCODE and did not create an upload ZIP."
  }
}

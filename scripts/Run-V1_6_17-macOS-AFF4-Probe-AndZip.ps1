param(
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V1_6_17",
  [string]$Aff4Path = "O:\0109_0142-IT001\disk3 2024-10-01 10-43-40\0109_0142-IT001.aff4",
  [string]$CaseRoot = "Q:\SpotlightCase\TestMacOS_AFF4_V1_6_17",
  ...
  [string]$ExternalCompareOutRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_17_ExternalCompare",
  [string]$UploadWorkRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_17_UploadWork",
  [string]$ZipPath = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_17.zip",
  [switch]$CleanOut,
...
if ($LASTEXITCODE -ne 0) { throw "AFF4/APFS V1.6.17 probe wrapper failed with exit code $LASTEXITCODE. Review case folder: $CaseRoot" }

param(
  ...
  [string]$ExternalCompareOutRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_102_ExternalCompare",
  [string]$UploadWorkRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_102_UploadWork",
...
if ($LASTEXITCODE -ne 0) { throw "AFF4/APFS V1.6.102 probe wrapper failed with exit code $LASTEXITCODE. Review case folder: $CaseRoot" }

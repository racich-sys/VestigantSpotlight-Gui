param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\ProductionIOS_CoreSpotlight_V1_6_7_1",
  [string]$ZipPath = "D:\Downloads\Upload_Production_iOS_CoreSpotlight_V1_6_7_1.zip",
  [switch]$CleanOut,
...
if ($LASTEXITCODE -ne 0) {
  ...
  throw "iOS CoreSpotlight V1.6.7.1 production wrapper failed with exit code $LASTEXITCODE"
}

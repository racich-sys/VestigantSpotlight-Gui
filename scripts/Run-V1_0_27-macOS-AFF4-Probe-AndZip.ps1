param(
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V1_0_27",
  [string]$Aff4Input = "O:\0109_0142-IT001\disk3 2024-10-01 10-43-40\0109_0142-IT001.aff4",
  [string]$CaseRoot = "Q:\SpotlightCase\TestMacOS_AFF4_V1_0_27",
  [string]$ReaderToolsRoot = "T:\VestigantReaderTools\aff4-cpp-lite",
  [string]$ZipPath = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_0_27.zip",
...
if (!$SkipExternalCompare -and (Test-Path -LiteralPath $ExternalSpotlightRoot)) {
  ...
  $args.ExternalCompareOutRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_0_27_ExternalCompare"
...
& $runner @args
if ($LASTEXITCODE -ne 0) { throw "AFF4/APFS V1.0.27 probe wrapper failed with exit code $LASTEXITCODE" }

param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\ValidationSupportIOS_CoreSpotlight_V1_6_72",
  [string]$ZipPath = "D:\Downloads\Upload_ValidationSupport_iOS_CoreSpotlight_V1_6_72.zip",
  [switch]$CleanOut,
...
if ($LASTEXITCODE -ne 0) {
  ...
  throw "iOS CoreSpotlight V1.6.72 validation support wrapper failed with exit code $LASTEXITCODE"
}

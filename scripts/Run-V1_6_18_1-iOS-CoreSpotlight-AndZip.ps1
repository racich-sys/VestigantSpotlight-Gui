param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\TestIOS_CoreSpotlight_V1_6_18_1",
  [string]$ZipPath = "D:\Downloads\Upload_Thin_iOS_CoreSpotlight_V1_6_18_1.zip",
  [switch]$CleanOut,
...
if ($LASTEXITCODE -ne 0) {
  ...
  if (Test-Path -LiteralPath $ZipPath) {
    ...
    Write-Warning "iOS CoreSpotlight thin run failed; upload ZIP renamed to: $failedZip"
  }
  throw "iOS CoreSpotlight V1.6.18.1 thin wrapper failed with exit code $LASTEXITCODE"
}

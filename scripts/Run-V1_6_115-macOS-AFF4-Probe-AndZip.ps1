param(
  ...
  [string]$ExternalCompareOutRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_115_ExternalCompare",
  [string]$UploadWorkRoot = "D:\Downloads\Upload_Thin_MacOS_AFF4_V1_6_115_UploadWork",
...
if ($LASTEXITCODE -ne 0) { throw "AFF4/APFS V1.6.115 probe wrapper failed with exit code $LASTEXITCODE. Review case folder: $CaseRoot" }

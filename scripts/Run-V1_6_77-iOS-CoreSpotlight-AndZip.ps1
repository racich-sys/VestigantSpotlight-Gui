param(
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\TestIOS_CoreSpotlight_V1_6_77",
  [string]$ZipPath = "D:\Downloads\Upload_Thin_iOS_CoreSpotlight_V1_6_77.zip",
  [switch]$CleanOut,
...
if ($LASTEXITCODE -ne 0) {
  if (Test-Path -LiteralPath $ZipPath) {
    ...
    throw "iOS CoreSpotlight V1.6.77 thin wrapper failed with exit code $LASTEXITCODE and did not create an upload ZIP."
  }
}

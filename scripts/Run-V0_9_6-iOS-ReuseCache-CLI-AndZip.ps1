param(
  [string]$SourceRoot = "T:\VestigantSpotlightInv_V0_9_6",
  ...
  [string]$CaseRoot = "Q:\SpotlightCase\TestiOS_WhatsApp_V0_9_6_ReusedCache",
  [string]$OutZip = "D:\Downloads\Upload_Thin_iOS_GUI_V0_9_6_ReusedCache_Check.zip"
)
...
powershell -ExecutionPolicy Bypass -File "$SourceRoot\scripts\Package-V0_9_6-iOS-ThinUpload.ps1" -CaseRoot $CaseRoot -OutZip $OutZip

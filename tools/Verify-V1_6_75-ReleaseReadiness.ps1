...
WarnIfMissing "docs\PROJECT_REFERENCE_V1_6_87.md" @($expected, 'red-team', 'date-count metric cache', 'Markdown files consolidated')
WarnIfMissing "docs\START_CONTINUATION_CHAT.md" @($expected, 'Continue the Vestigant Spotlight / Spotlight2 Project from V1.6.87', 'enrichment_metrics_date_count_cache_complete')
...
RequireContains "BuildAndRunThin-V1_6_87-FromDownloadedZip.ps1" @('UseFastLocalCaseRoot', 'FastLocalRoot', 'TestIOS_CoreSpotlight_V1_6_87', 'IosReuseCacheWrapperLogEntries', 'Flush-IosReuseCacheWrapperLog', 'preserves entries if -CleanOut removed the initial case log')
RequireContains "scripts\BuildAndRunThin-V1_6_87-FromDownloadedZip.ps1" @('UseFastLocalCaseRoot', 'FastLocalRoot', 'TestIOS_CoreSpotlight_V1_6_87', 'IosReuseCacheWrapperLogEntries', 'Flush-IosReuseCacheWrapperLog', 'preserves entries if -CleanOut removed the initial case log')
RequireContains "BuildAndRunAff4Probe-V1_6_87-FromDownloadedZip.ps1" @('Aff4Path', 'FullNoGuardrails', 'Run-SingleAff4SourceProbeAndZip.ps1', 'EnableAff4DynamicProbe', 'EnableAff4VirtualApfsProbe')
RequireContains "scripts\BuildAndRunAff4Probe-V1_6_87-FromDownloadedZip.ps1" @('Aff4Path', 'FullNoGuardrails', 'Run-SingleAff4SourceProbeAndZip.ps1', 'EnableAff4DynamicProbe', 'EnableAff4VirtualApfsProbe')
...
RequireContains "scripts\Run-V1_6_87-macOS-AFF4-Probe-AndZip.ps1" @('FullNoGuardrails', 'RequireStoreV2ValidationOutputs', 'Partial AFF4/APFS diagnostic uploads are allowed')

RequireContains "BuildAndRun-V1_6_87-FromDownloadedZip.ps1" @('IOSCoreSpotlightThin', 'AFF4Probe', 'BuildOnly', 'SelectedWorkflow', 'BuildAndRunThin-V1_6_87-FromDownloadedZip.ps1', 'BuildAndRunAff4Probe-V1_6_87-FromDownloadedZip.ps1', 'documentation placeholder')
RequireContains "scripts\BuildAndRun-V1_6_87-FromDownloadedZip.ps1" @('IOSCoreSpotlightThin', 'AFF4Probe', 'BuildOnly', 'SelectedWorkflow', 'BuildAndRunThin-V1_6_87-FromDownloadedZip.ps1', 'BuildAndRunAff4Probe-V1_6_87-FromDownloadedZip.ps1', 'documentation placeholder')
RequireContains "scripts\Build-V1_6_87.ps1" @('VestigantSpotlightTests.exe', 'Running required self-test', 'Self-test completed', 'SkipSelfTest', 'Invoke-SelfTestProcessToLog', 'stderr alone is not a failure')

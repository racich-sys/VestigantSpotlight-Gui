param(
  ...
  [string]$ReportRoot = "D:\Downloads\iOS_CoreSpotlight_QuickDiagnostics_V1_0_17",
  [string]$ReportZip = "D:\Downloads\iOS_CoreSpotlight_QuickDiagnostics_V1_0_17.zip",
  [string]$EvidenceRoot = "D:\Downloads\iOS_CoreSpotlight_MinimalEvidence_V1_0_17",
  [string]$EvidenceZip = "D:\Downloads\iOS_CoreSpotlight_MinimalEvidence_V1_0_17.zip",

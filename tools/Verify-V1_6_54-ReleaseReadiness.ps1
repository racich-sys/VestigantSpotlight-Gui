...
RequireContains "BuildAndRunThin-V1_6_101-FromDownloadedZip.ps1" @('UseFastLocalCaseRoot', 'FastLocalRoot', 'TestIOS_CoreSpotlight_V1_6_101')
RequireContains "scripts\BuildAndRunThin-V1_6_101-FromDownloadedZip.ps1" @('UseFastLocalCaseRoot', 'FastLocalRoot', 'TestIOS_CoreSpotlight_V1_6_101')

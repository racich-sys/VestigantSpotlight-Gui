...
RequireContains "BuildAndRunThin-V1_6_119-FromDownloadedZip.ps1" @('UseFastLocalCaseRoot', 'FastLocalRoot', 'TestIOS_CoreSpotlight_V1_6_119')
RequireContains "scripts\BuildAndRunThin-V1_6_119-FromDownloadedZip.ps1" @('UseFastLocalCaseRoot', 'FastLocalRoot', 'TestIOS_CoreSpotlight_V1_6_119')

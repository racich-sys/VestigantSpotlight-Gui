...
$build = Get-Content -LiteralPath (Join-Path $SourceRoot "scripts\Build-V1_6_0.ps1") -Raw
if ($build -notmatch "1\\.6\\.0") { throw "Build wrapper does not check 1.6.0" }
$ios = Join-Path $SourceRoot "scripts\Run-V1_6_0-iOS-CoreSpotlight-AndZip.ps1"
